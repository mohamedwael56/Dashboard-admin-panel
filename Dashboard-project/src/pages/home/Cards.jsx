...
export function Cards (){
    ...
    return (
        <>
            ...
            <button className="flex justify-between h-64 row-span-2 bg-gradient-to-r from-pink-500 to-pink-300 p-4 text-white">
              <div className="flex w-full flex-col justify-between h-full items-start">
                <div className="flex flex-col items-start">
            ...
            <button className=" capitalize row-span-4 bg-gradient-to-r from-blue-500 to-blue-200 p-6 text-white flex flex-col gap-2 items-start">
            ...
            <button className="flex justify-between row-span-2 bg-gradient-to-r from-blue-700 to-blue-300 p-4 text-white">
            ...
            <button className=" flex justify-between h-64 row-span-2 bg-gradient-to-r from-amber-500 to-amber-200 p-4 text-white">
              <div className="flex flex-col w-full justify-between items-start">
                <div className="flex flex-col items-start">
